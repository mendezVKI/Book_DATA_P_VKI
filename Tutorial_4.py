...
Script of Exercise 4: computing turbulence statistics from PIV data.
"""
...
# save figure
fig.savefig(Fol_Plots + os.sep + 'Ex4_u_mean_v_mean_PIV.png')
...
fig.savefig(Fol_Plots + os.sep + 'Ex4_TKE.png')
...
ax.set_aspect(1)
fig.set_constrained_layout_pads()
fig.savefig(Fol_Plots + os.sep + 'Ex4_A_tensor.png')
...
fig.set_constrained_layout_pads()
fig.savefig(Fol_Plots + os.sep + 'Ex4_Lumley_triangle.png')
