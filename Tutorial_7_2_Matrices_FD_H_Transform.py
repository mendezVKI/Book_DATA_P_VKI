...
with imageio.get_writer('heat_equation_solution_matrix_transformed.gif', mode='I', duration=0.1) as writer:
...
print("Animated GIF saved as 'heat_equation_solution_matrix_transformed'")
