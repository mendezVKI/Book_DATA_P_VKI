...
# Note : this should run AFTER the file 
# Tutorial_7_Matrices_FD_H_Transform, since the result of this spectral
# implementation will be compared with those with FD from that file.
...
with imageio.get_writer('Spectral_H_Transform.gif', mode='I', duration=0.1) as writer:
...
print("Animated GIF saved as 'Spectral_H_Transform.gif'")



# Load the Finite Difference results and compare some snapshots 
